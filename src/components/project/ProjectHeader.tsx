      ...
      <div className="header-actions" style={{ display: 'flex', gap: 4, alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
        ...
        <div className="view-buttons" style={{ 
          ...
          {[
            ...
            {
              id: 'calendar', label: 'Calendar', feature: 'calendar_view' as Feature,
              icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {
              id: 'table', label: 'Table', feature: 'table_view' as Feature,
              icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {
              id: 'timeline', label: 'Timeline', feature: 'timeline_view' as Feature,
              icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
